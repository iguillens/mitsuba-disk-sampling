...
public:
	...
	/**
	 * Read the "Importance Sampling of Area Lights in Participating Media" paper.
	 * Done as a distinct method to avoid breaking things elsewhere
	 */
	void sampleEmitterEquiangular(const Ray &ray, PositionSamplingRecord &pRec,
	 ...
	 * Done as a distinct method to avoid breaking things elsewhere
	 */
	void sampleEmitterEquiangularNonCenter(const Ray &ray,
